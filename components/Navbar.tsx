        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            >
              ...
              {isDropdownOpen && (
                <div className="absolute top-full left-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-primary/10 py-2 z-50">
                  <Link
                    href="/a-propos"
      ...
      {isOpen && (
        <div className="md:hidden bg-pure-white border-t border-primary/10 animate-in slide-in-from-top-2">
          <div className="px-4 py-4 space-y-4">
            ...
            <Link href="/faire-un-don" className="block w-fit bg-secondary text-primary-dark px-6 py-2.5 rounded-full font-semibold" onClick={() => setIsOpen(false)}>Faire un don</Link>
          </div>
        </div>
      )}
    </nav>
